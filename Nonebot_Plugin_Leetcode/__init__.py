...
leetcodeTmp = "C:/CodePython/Bot_leetcode/bot_leetcode/plugins/leetcode_everyday/data/leetcodeTmp.html"#在此更改leetcodeTmp.html路径
PathPng = "file:///C:\CodePython\Bot_leetcode\\bot_leetcode\plugins\leetcode_everyday\data\\1.png" #在此更改png路径

def activeShotHtml():
    # 首先创建一个保存截图的文件夹
    filename = "C:/CodePython/Bot_leetcode/bot_leetcode/plugins/leetcode_everyday/data/"    #在此更改文件夹路径 
    ...
    for line in lines:
            ...
            driver.get_screenshot_as_file(filename + picname)
